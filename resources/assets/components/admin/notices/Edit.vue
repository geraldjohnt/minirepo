            ...
            <div class="wrapper">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-8">
                        ...
                        <form autocomplete="off" v-if="dataloaded" @submit.prevent="updateNotice">
                            ...
                            <div class="ui-button-group">
                                ...
                                <ui-button type="normal" button-type="submit" color="success">Update Notice</ui-button>
                            </div>
                        </form>
                    </div>
...
export default {
    ...
    methods: {
        updateNotice() {
            ...
            admin.updateNotice(this, this.$route.params, data)
        },
        toggleValidation() {
    ...
    ready() {
        ...
        admin.getNotice(this, this.$route.params)
    },
    components: {
        // AdminSidebar,
        StaffSidebar,
