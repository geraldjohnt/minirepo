...
function MediaStreamRecorder(mediaStream) {
    ...
    // console.log('MediaStreamRecorder FUNCTION');
    ...
    this.start = function(timeSlice) {
        ...
        // console.log("pass here - this.start");
        ...
        if (typeof mediaRecorder !== 'undefined') {            
            ...
            // console.log("IsChrome || IsOpera || IsEdge");
            if (this.mimeType.indexOf('video') !== -1) {
                Recorder = WhammyRecorder;
            } else if (this.mimeType.indexOf('audio') !== -1) {
                Recorder = StereoAudioRecorder;
            }
        // added condition for Safari
        } else {
            // console.log("IsSafari or IsFireFox");
            if (this.mimeType.indexOf('audio') !== -1) {
                // console.log("Safari audio");
                Recorder = StereoAudioRecorder;
            }            
        }
        ...
        // console.log("to pass blobs empty");            
        ...
        // console.log("to pass mergeProps");        

        // Merge all data-types except "function"
        mediaRecorder = mergeProps(mediaRecorder, this);

        // console.log("to pass mediaRecorder.start");
    ...
    this.stop = function() {
        // console.log("going if (mediaRecorder)");
        if (mediaRecorder) {
            // console.log("going mediaRecorder.stop();");
            mediaRecorder.stop();
        }
    };

    this.ondataavailable = function(blob) {
        // console.log("going this.ondataavailable");
        if (this.disableLogs) return;
        // console.log('ondataavailable..', blob);
    };

    this.onstop = function(error) {
        // console.log("going this.onstop");
...
function MultiStreamRecorder(arrayOfMediaStreams, options) {
    ...
    this.start = function(timeSlice) {
        ...
        // console.log('this.start: ', arrayOfMediaStreams);
    ...
    this.stop = function(callback) {
        // console.log("this.stop = function(callback)");
        if (!mediaRecorder) {
            return;
        }

        // console.log("mediaRecorder.stop(function(blob)");
...
function GifRecorder(mediaStream) {
    ...
    this.start = function(timeSlice) {
        ...
        function drawVideoFrame(time) {
            ...
            console.log("MSR ---- lastAnimationFrame");
            ...
            console.log('Media Stream Recorder Recording...' + Math.round((Date.now() - startTime) / 1000) + 's');
            console.log("Media Stream Recorder fps: ", 1000 / (time - lastFrameTime));
        ...
        console.log("MSR ---- lastAnimationFrame 2");
