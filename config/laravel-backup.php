...
return [
    ...
    'notifications' => [
         ...
         */
        'events' => [
            'whenBackupWasSuccessful'     => ['slack'],
            'whenCleanupWasSuccessful'    => ['slack'],
            'whenHealthyBackupWasFound'   => ['slack'],
            'whenBackupHasFailed'         => ['slack'],
            'whenCleanupHasFailed'        => ['slack'],
            'whenUnhealthyBackupWasFound' => ['slack'],
        ],
         ...
         */
        'slack' => [
            'webhook_url' => 'https://hooks.slack.com/services/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',
	    'channel' => '#mee2box',
            'username' => 'TotoyMee2boxUpdate',
            'icon' => ':robot:',
        ],
